...
class GFNAlgorithm:
    ...
    def compute_batch_losses(self, model: nn.Module, batch: gd.Batch, num_bootstrap: Optional[int] = 0) -> tuple[Tensor, dict[str, Tensor]]:
...
class GFNTask:
    ...
    def compute_obj_properties(self, objs: list[Any], **kwargs) -> tuple[ObjectProperties, Tensor]:
