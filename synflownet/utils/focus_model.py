...
class TabularFocusModel(FocusModel):
    ...
    def sample_focus_directions(self, n: int):
        ...
        sampling_likelihoods[torch.logical_and(self.focus_dir_count > 0, self.focus_dir_population_count > 0)] = self.feasible_flow
        sampling_likelihoods[torch.logical_and(self.focus_dir_count > 0, self.focus_dir_population_count == 0)] = self.infeasible_flow
